...
class DataAnalysis:
    ...
    def __init__(self, path_all: str) -> None:
    ...
    @classmethod
    def count_colums(cls, filePath):
        return pd.read_html(filePath)[0][2:].columns
    ...
    def joins_dfs2(self):
        ...
        self.df_principal.to_excel(f'{self.path}/{file_name}', engine="openpyxl", index=False)
        ...
        print(msg_final)
        print("errors:", errors)
        return len(self.df_principal.columns)
